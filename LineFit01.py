...
def main():
    ...
    # Actually run
    SIMBA.start(args.i, table_url = args.table, comment = "Job started /w %i chains, %i samples, %i burn in and %i cores" %(nchains, args.Nsamples, args.Nburn, args.Ncores))
    ...
    SIMBA.finish(args.i, table_url = args.table, comment = "Job done /w %i chains, %i samples, %i burn in and %i cores" %(nchains, args.Nsamples, args.Nburn, args.Ncores))
